...
export function buildInquiryMessage(productTitle) {
  if (productTitle) {
    return `Добрий день. Мене цікавить товар: ${productTitle}. Підкажіть, будь ласка, ціну, наявність та умови постачання.`;
  }
  return `Добрий день. Хочу отримати прайс на продукцію від виробника пневмоподушок.`;
}
