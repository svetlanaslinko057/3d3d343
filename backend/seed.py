...
CATEGORIES = [
    {
        "slug": "air-springs",
        "title": "Пневмоподушки",
        "shortDescription": "Посилені пневмоподушки власного виробництва — широкий типорозмірний ряд",
        "image": CLOSEUP[0],
        "icon": "Disc3",
        "order": 1,
    },
    {
        ...
        "shortDescription": "Повні комплекти: подушки + компресор + керування — серія та OEM",
        "image": KITS[0],
        "icon": "Layers",
        "order": 2,
    },
    ...
    },
    {
        ...
        "shortDescription": "Виготовлення під технічне завдання та нестандартні задачі",
        "image": INSTALL[2],
        "icon": "Sparkles",
        "order": 4,
    },
    {
        "slug": "by-vehicle",
        "title": "За застосуванням",
        "shortDescription": "Універсальні рішення — куди й як інтегрувати, вирішує клієнт",
        "image": VEHICLES[0],
        "icon": "Truck",
        "order": 5,
    },
...
PRODUCTS = [
    {
        "title": "Пневмоподушки посилені (серія RP-2010)",
        "slug": "air-springs-serial",
        "category": "air-springs",
        "shortDescription": "Серійна посилена модель — стабільність під навантаженням до 1500 кг",
        "fullDescription": "Посилені пневмоподушки власного виробництва. Стандартний типорозмір серії RP-2010. Витримують навантаження до 1500 кг, ресурс — понад 200 000 циклів. Інтеграція в будь-яке застосування — рішення за клієнтом. Гарантія від виробника 12 місяців.",
        "image": CLOSEUP[0],
        "gallery": [CLOSEUP[0], INSTALLED[0], INSTALLED[1], VEHICLES[0], CLOSEUP[3]],
        "status": "in_stock",
        "badge": "Власне виробництво",
        "vehicleTypes": ["Серійна продукція", "Універсальна"],
        "featured": True,
        "sortOrder": 1,
    },
    {
        "title": "Комплект пневмопідвіски (стандарт)",
        "slug": "air-suspension-kit-standard",
        "category": "air-suspension",
        "shortDescription": "Повний комплект із виробництва: подушки + компресор + керування",
        "fullDescription": "Стандартний комплект пневмопідвіски власного виробництва: дві пневмоподушки, компресор 12В з ресивером, електропневматичний блок керування, пульт, магістралі, фітинги, манометр. Виготовлення 5–10 робочих днів. Універсальне застосування — клієнт сам визначає інтеграцію.",
        "image": KITS[0],
        "gallery": [KITS[0], KITS[1], INSTALLED[2], INSTALL[0], COMPONENTS[0]],
        "status": "on_order",
        "badge": "Серія",
        "vehicleTypes": ["Комплект", "Стандарт"],
        "featured": True,
        "sortOrder": 2,
    },
    {
        "title": "Пневмоподушки балонні в пружину",
        "slug": "air-springs-balloon",
        "category": "air-springs",
        "shortDescription": "Балонна серія — регулювання жорсткості без зварювання",
        "fullDescription": "Пневмоподушки балонного типу для установки всередину пружини. Дозволяють регулювати висоту та жорсткість підвіски. Універсальне рішення — підходить для широкого спектру задач. Монтаж без зварювання. Власне виробництво, гарантія 12 місяців.",
        "image": CLOSEUP[1],
        "gallery": [CLOSEUP[1], INSTALLED[3], INSTALLED[4], VEHICLES[1], CLOSEUP[4]],
        "status": "in_stock",
        "badge": "ТОП",
        "vehicleTypes": ["Балонна серія", "Універсальна"],
        "featured": True,
        "sortOrder": 3,
    },
    {
        "title": "Комплект пневмопідвіски посилений",
        "slug": "air-suspension-kit-heavy",
        "category": "air-suspension",
        "shortDescription": "Посилена пара подушок ×2 — навантаження до 3000 кг кожна",
        "fullDescription": "Посилений комплект пневмопідвіски: дві посилені подушки (до 3000 кг кожна), потужний компресор, електроблок, балансувальний клапан. Розрахований на високі навантаження. Інтеграція під вашу задачу.",
        "image": KITS[1],
        "gallery": [KITS[1], KITS[2], INSTALLED[5], INSTALLED[6], COMPONENTS[1]],
        "status": "on_order",
        "badge": "Посилений",
        "vehicleTypes": ["Посилена серія", "Великі партії"],
        "featured": True,
        "sortOrder": 4,
    },
    {
        ...
        "category": "air-suspension",
        "shortDescription": "Рішення для причепів — рівна площадка під будь-яким вантажем",
        "fullDescription": "Комплект пневмопідвіски для причепів. Пара пневмоподушок, компресор 12В, магістралі, дистанційний пульт. OEM-партії для виробників причепів — за технічним завданням замовника.",
        "image": KITS[2],
        "gallery": [KITS[2], INSTALLED[7], INSTALLED[8], INSTALL[1], COMPONENTS[0]],
        "status": "on_order",
        "badge": None,
        "vehicleTypes": ["OEM партії", "Причепи"],
        "featured": True,
        "sortOrder": 5,
    },
    {
        ...
        "fullDescription": "Компресор 12В з металевим ресивером 3 л. Продуктивність 50 л/хв, тиск до 10 бар. Захист від перегріву, реле тиску в комплекті. Стандартний компонент пневмосистеми — підходить до будь-якого комплекту.",
        "image": COMPONENTS[0],
        "gallery": [COMPONENTS[0], COMPONENTS[1], KITS[0], KITS[1]],
        "status": "in_stock",
        "badge": None,
        "vehicleTypes": ["Універсальна"],
        "featured": True,
        "sortOrder": 6,
    },
    {
    ...
    },
    {
        ...
        "slug": "dual-manometer",
        "category": "components",
        "shortDescription": "Точний контроль тиску обох контурів пневмосистеми",
        "fullDescription": "Електронний подвійний манометр для контролю тиску лівого та правого контурів пневмопідвіски. Діапазон 0–12 бар, підсвітка, монтаж у панель приладів або пульт керування.",
        "image": COMPONENTS[0],
    ...
    {
        "title": "Індивідуальне рішення під ТЗ",
        "slug": "custom-solution-special",
        "category": "custom-solutions",
        "shortDescription": "Інженерний розрахунок та виготовлення під конкретну задачу",
        "fullDescription": "Індивідуальний підбір та виготовлення комплекту пневмопідвіски під технічне завдання замовника: специфікація, CAD-креслення, виробництво, тестування. Гарантія 24 місяці. Інтеграція — на боці клієнта.",
        "image": VEHICLES[2],
        "gallery": [VEHICLES[2], DIAGRAM[0], INSTALLED[11], INSTALL[2], CLOSEUP[5]],
        "status": "on_order",
        "badge": "Під ТЗ",
        "vehicleTypes": ["Індивідуально під ТЗ", "Промислові застосування"],
        "featured": False,
        "sortOrder": 9,
    },
    {
        "title": "Пневмоподушки компактні (балонна серія)",
        "slug": "air-springs-compact",
        "category": "air-springs",
        "shortDescription": "Компактні подушки всередину пружини — швидка установка без зварювання",
        "fullDescription": "Компактні пневмоподушки балонного типу для установки всередину пружини. Дозволяють регулювати жорсткість та висоту. Універсальна серія — підходить для широкого спектру задач.",
        "image": CLOSEUP[2],
    ...
    },
    {
        ...
        "category": "by-vehicle",
        "shortDescription": "Рішення для кемперів, автодомів та переобладнаних фургонів",
        "fullDescription": "Спеціальний комплект пневмопідвіски для кемперів, автодомів та переобладнаних фургонів. Підсилення під постійне навантаження + максимальний комфорт та рівна площадка. OEM-серія від виробника.",
        "image": VEHICLES[1],
        "gallery": [VEHICLES[1], INSTALLED[14], INSTALLED[15], KITS[0]],
        "status": "on_order",
        "badge": None,
        "vehicleTypes": ["Кемпери / RV", "Універсальна"],
        "featured": False,
        "sortOrder": 13,
    },
]
...
FAQ_ITEMS = [
    ...
    },
    {
        ...
        "answer": "Стандартна лінійка серійних типорозмірів та універсальних балонних подушок у пружину — на складі. Нестандартні розміри та OEM-партії — виготовлення 5–14 днів за специфікацією замовника.",
        "order": 6,
    },
    {
...
PUBLIC_GALLERY = [
    {"image": INSTALLED[0],  "caption": "Серійна пневмоподушка в роботі",   "tag": "Серія"},
    {"image": CLOSEUP[0],    "caption": "Пневмоподушка крупним планом",    "tag": "Виробництво"},
    {"image": INSTALLED[4],  "caption": "Комплект у задній восі",          "tag": "Інтеграція"},
    {"image": KITS[0],       "caption": "Повний комплект з виробництва",   "tag": "Комплект"},
    {"image": INSTALLED[7],  "caption": "Посилена пара під навантаженням", "tag": "Посилена"},
    {"image": CLOSEUP[3],    "caption": "Партія готових виробів",           "tag": "Виробництво"},
    {"image": VEHICLES[0],   "caption": "Універсальне застосування",        "tag": "Застосування"},
    ...
    {"image": KITS[2],       "caption": "OEM-комплект на замовлення",        "tag": "OEM"},
